...
for (let i = 0; i < card_db.length; i++) {
	...
	if (card_db[i].set == "PS1") {
		// Set card types
		if (card_db[i].setNumber <= 16)
			card_db[i].type = "EVO";
		else if (card_db[i].setNumber <= 21)
			card_db[i].type = "HERO";

		// Set card factions
		if (card_db[i].setNumber <= 3 || card_db[i].setNumber == 17)
			card_db[i].faction = [ "AQUOS" ];
		if (card_db[i].setNumber >= 4 && card_db[i].setNumber <= 6 || card_db[i].setNumber == 18)
			card_db[i].faction = [ "DARKUS" ];
		if (card_db[i].setNumber >= 7 && card_db[i].setNumber <= 10 || card_db[i].setNumber == 19)
			card_db[i].faction = [ "HAOS" ];
		if (card_db[i].setNumber >= 11 && card_db[i].setNumber <= 13 || card_db[i].setNumber == 20)
			card_db[i].faction = [ "PYRUS" ];
		if (card_db[i].setNumber >= 14 && card_db[i].setNumber <= 16 || card_db[i].setNumber == 21)
			card_db[i].faction = [ "VENTUS" ];
	}
	...
	if (card_db[i].set == "GG") {
		...
		if (card_db[i].setNumber <= 6 || (card_db[i].setNumber >= 133 && card_db[i].setNumber <= 137) || (card_db[i].setNumber >= 142 && card_db[i].setNumber <= 145) || card_db[i].setNumber == 201)
			card_db[i].faction = [ "AQUOS" ];
		if ((card_db[i].setNumber >= 11 && card_db[i].setNumber <= 20) || (card_db[i].setNumber >= 157 && card_db[i].setNumber <= 161) || (card_db[i].setNumber >= 166 && card_db[i].setNumber <= 167) || (card_db[i].setNumber >= 206 && card_db[i].setNumber <= 211))
			card_db[i].faction = [ "DARKUS" ];
		if ((card_db[i].setNumber >= 21 && card_db[i].setNumber <= 26) || (card_db[i].setNumber >= 168 && card_db[i].setNumber <= 171) || card_db[i].setNumber == 176)
			card_db[i].faction = [ "HAOS" ];
		if ((card_db[i].setNumber >= 31 && card_db[i].setNumber <= 36) || (card_db[i].setNumber >= 178 && card_db[i].setNumber <= 185) || card_db[i].setNumber == 217)
			card_db[i].faction = [ "PYRUS" ];
		if ((card_db[i].setNumber >= 41 && card_db[i].setNumber <= 46) || card_db[i].setNumber == 165 || card_db[i].setNumber == 175 || (card_db[i].setNumber >= 186 && card_db[i].setNumber <= 196))
			card_db[i].faction = [ "VENTUS" ];
	...
	if (card_db[i].set == "EV2") {
		// Set card types
		if (card_db[i].setNumber <= 48 || (card_db[i].setNumber >= 118 && card_db[i].setNumber <= 189))
			card_db[i].type = "GEOGAN";
		...
		if (card_db[i].setNumber == 36 || card_db[i].setNumber == 42)
			card_db[i].faction = [ "AQUOS" ];
		if (card_db[i].setNumber == 38 || card_db[i].setNumber == 53 || card_db[i].setNumber == 118)
			card_db[i].faction = [ "DARKUS" ];
		if (card_db[i].setNumber == 40 || card_db[i].setNumber == 59 || card_db[i].setNumber == 167)
			card_db[i].faction = [ "PYRUS" ];
		if (card_db[i].setNumber == 48 || (card_db[i].setNumber >= 61 && card_db[i].setNumber <= 63) || card_db[i].setNumber == 189)
			card_db[i].faction = [ "VENTUS" ];
		if (card_db[i].setNumber >= 55 && card_db[i].setNumber <= 57)
			card_db[i].faction = [ "HAOS" ];
		if (card_db[i].setNumber == 50)
			card_db[i].faction = [ "AURELUS" ];
	}
	...
	if (card_db[i].set == "LE") {
		...
		if (card_db[i].setNumber <= 5)
			...
			card_db[i].type = "GEOGAN";
		else if (card_db[i].setNumber <= 22)
			card_db[i].type = "EVO";

		// Set card factions
		if (card_db[i].setNumber == 1 || (card_db[i].setNumber >= 6 && card_db[i].setNumber <= 7) || (card_db[i].setNumber >= 11 && card_db[i].setNumber <= 12))
			card_db[i].faction = [ "DARKUS" ];
		...
		if ((card_db[i].setNumber >= 9 && card_db[i].setNumber <= 10) || card_db[i].setNumber == 17)
			card_db[i].faction = [ "PYRUS" ];
		if (card_db[i].setNumber >= 21 && card_db[i].setNumber <= 22)
			card_db[i].faction = [ "HAOS" ];
